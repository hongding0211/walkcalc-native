...
The system SHALL open group record search in a dedicated search canvas from the group detail page using a system sheet with a large presentation detent and without pushing a new destination onto the navigation stack.
