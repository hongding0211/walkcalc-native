# production-network-permissions Specification

## Purpose

Define which network permissions and local-discovery behavior are allowed in production versus development builds.
