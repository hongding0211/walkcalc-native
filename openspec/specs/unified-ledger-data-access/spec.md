# unified-ledger-data-access Specification

## Purpose
Define the unified repository and data-source contract that mediates WalkCalc ledger access across remote and local sources.
