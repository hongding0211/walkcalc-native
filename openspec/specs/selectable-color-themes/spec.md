# selectable-color-themes Specification

## Purpose

Define the supported selectable app themes, how theme choice persists locally, and which UI elements may adopt the selected accent palette.
