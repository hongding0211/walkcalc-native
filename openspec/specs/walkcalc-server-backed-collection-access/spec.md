# walkcalc-server-backed-collection-access Specification

## Purpose
Define how WalkCalc loads and searches server-backed group and record collections with explicit pagination and backend filtering.
