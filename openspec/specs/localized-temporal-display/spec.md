# localized-temporal-display Specification

## Purpose

Define how Walkcalc formats user-visible date and time strings by locale, recency, and display context.
...
The system SHALL use the compact context for dense visual rows, the dense context for narrow row metadata columns, and the full context where exact timestamp information is necessary.
